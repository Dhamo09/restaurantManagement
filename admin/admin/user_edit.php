...
?>
    ...
    <head>
        ...
        <title>Texi Services | Edit user</title>
        <?php
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="user.php"> User</a></li>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <?php
                                                ...
                                                {
                                                    $user_id=$_GET['id'];
                                                    $upcontact="SELECT * FROM user WHERE id='".$user_id."' ";
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                       value="<?php echo $edit['name'];?>" name="editname">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                       value="<?php echo $edit['password'];?>" name="editpassword">
                                                </div>
                                            </div>
                                            <input type="hidden" name="user_id" value="<?php echo $edit['ID'];?>">
                                            <!-- /.card-body -->
